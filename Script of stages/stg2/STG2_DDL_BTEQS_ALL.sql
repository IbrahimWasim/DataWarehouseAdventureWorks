...
DATABASE DB_STG2;
--HR Module
CREATE TABLE DB_STG2.Department
(
...
CREATE TABLE DB_STG2.EmployeeDepartmentHistory
(
           BusinessEntityID INTEGER,
...
CREATE TABLE DB_STG2.ProductVendor
(
           BusinessEntityID INTEGER,
		   ProductID INTEGER,
...
CREATE TABLE DB_STG2.PurchaseOrderDetail
(
...
CREATE TABLE DB_STG2.PurchaseOrderHeader
(
           PurchaseOrderID INTEGER,
...
CREATE TABLE DB_STG2.ShipMethod
(
           ShipMethodID INTEGER,
           Name1 VARCHAR(32),
...
CREATE TABLE DB_STG2.AddressType(
AddressTypeID INTEGER,
Name1 VARCHAR(8)
)
PRIMARY INDEX(AddressTypeID);

CREATE TABLE DB_STG2.BusinessEntity
(
BusinessEntityID INTEGER
)
PRIMARY INDEX(BusinessEntityID);

CREATE TABLE DB_STG2.BusinessEntityAddress(
AddressID INTEGER,
BusinessEntityID INTEGER,
...
CREATE TABLE DB_STG2.ContactType
(
BusinessEntityID INTEGER,
Name1 VARCHAR(16)
)
...
CREATE TABLE DB_STG2.CountryRegion
(
...
CREATE TABLE DB_STG2.EmailAddress
(
BusinessEntityID INTEGER,
...
CREATE TABLE DB_STG2.Passwords
(
BusinessEntityID INTEGER,
...
CREATE TABLE DB_STG2.PhoneNumberType(
...
CREATE TABLE DB_STG2.PersonPhone
(
BusinessEntityID INTEGER,
...
CREATE TABLE DB_STG2.StateProvince
(
StateProvinceID INTEGER,
...
CREATE TABLE DB_STG2.BillofMaterials(
...
CREATE TABLE DB_STG2.Culture(
CultureID VARCHAR(8),
Name1 VARCHAR(16)
)
PRIMARY INDEX(CultureID);

CREATE TABLE DB_STG2.Product (
ProductID INTEGER,
Name1 VARCHAR(32),
...
CREATE TABLE DB_STG2.ProductCategory(
ProductCategoryID SMALLINT,
Name1  VARCHAR(16)
)
PRIMARY INDEX(ProductCategoryID);

CREATE TABLE DB_STG2.ProductCostHistory  (
ProductID INTEGER,
StartDate DATE FORMAT 'MM/DD/YYYY',
EndDate DATE FORMAT 'MM/DD/YYYY',
StandardCost DECIMAL(10,2)
...
CREATE TABLE DB_STG2.ProductDescription(
ProductDescriptionID INTEGER,
Description VARCHAR(512)
)
PRIMARY INDEX(ProductDescriptionID);

CREATE TABLE DB_STG2.ProductInventory (
ProductID INTEGER,
LocationID SMALLINT,
Shelf  VARCHAR(16),
Bin  VARCHAR(16),
...
CREATE TABLE DB_STG2.ProductListPriceHistory  (
ProductID INTEGER,
StartDate DATE FORMAT 'MM/DD/YYYY',
EndDate DATE FORMAT 'MM/DD/YYYY',
ListPrice DECIMAL(10,2)
...
CREATE TABLE DB_STG2.ProductModel (
...
CREATE TABLE DB_STG2.ProductModelProductDesctriptionCulture (
ProductModelID SMALLINT,
ProductDescriptionID INTEGER,
CultureID VARCHAR(8)
)
...
CREATE TABLE DB_STG2.ProductSubCategory(
...
CREATE TABLE DB_STG2.ScrapReason (
ScrapReasonID INTEGER,
Name1 VARCHAR(64)
)
PRIMARY INDEX(ScrapReasonID);

CREATE TABLE DB_STG2.TransactionHistory(
...
CREATE TABLE DB_STG2.UnitMeasure (
UnitMeasureCode CHAR(8),
Name1 VARCHAR(32)
)
PRIMARY INDEX(UnitMeasureCode);

CREATE TABLE DB_STG2.WorkOrder(
WorkOrderID INTEGER,
ProductID INTEGER,
OrderQty INTEGER,
StockedQty INTEGER,
...
CREATE TABLE DB_STG2.WorkOrderRouting(
WorkOrderID INTEGER,
ProductID INTEGER,
...
CREATE TABLE DB_STG2.CreditCard(
...
CREATE TABLE DB_STG2.CurrencyRate(
...
PRIMARY INDEX (CustomerID);
	...
	CREATE TABLE DB_STG2.PersonCreditCard(
	    BusinessEntityID INTEGER,
		CreditCardID INTEGER
		)
		PRIMARY INDEX(BusinessEntityID,CreditCardID);
		
CREATE TABLE DB_STG2.SalesOrderDetail
	(
		BusinessEntityID INTEGER,
...
CREATE TABLE DB_STG2.SalesOrderHeader
	(
		BusinessEntityID INTEGER,
		SalesOrderID	INTEGER,
		ShipMethodID	INTEGER,
...
CREATE TABLE DB_STG2.SalesOrderHeaderSalesReason
	(
	    BusinessEntityID INTEGER,
		SalesOrderID INTEGER,
...
CREATE TABLE DB_STG2.SalesPerson(
		BusinessEntityID INTEGER,
		TerritoryID INTEGER,
...
CREATE TABLE DB_STG2.SalesPersonQuotaHistory
	(
	  BusinessEntityID INTEGER,
	  SalesQuota DECIMAL(10,2),
...
CREATE TABLE DB_STG2.SalesReason
	(
		SalesReasonID INTEGER,
		Name1 VARCHAR(32),
...
CREATE TABLE DB_STG2.SalesTerritory
	(
	  TerritoryID INTEGER,
      Name1 VARCHAR(40),
...
CREATE TABLE DB_STG2.SalesTaxRate
	(
...
CREATE TABLE DB_STG2.SalesTerritoryHistory
	(
	  BusinessEntityID INTEGER,
	  TerritoryID INTEGER,
      StartDate DATE FORMAT 'MM/DD/YYYY',
...
PRIMARY INDEX (BusinessEntityID,TerritoryID,StartDate);
	...
	CREATE TABLE DB_STG2.ShoppingCartItem
	(
...
CREATE TABLE DB_STG2.SpecialOffer
	(
		SpecialOfferID INTEGER ,
...
CREATE TABLE DB_STG2.SpecialOfferProduct
	(
		SpecialOfferID INTEGER,
		ProductID INTEGER 
	)
